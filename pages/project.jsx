  ...
  const projects = [
    {
      ...
      stargazerCount: "100",
      description:
        "The smart digital event planner for event pros, venues, vendors, and organizers to collaborate and plan any successful event all in one place.",
    ...
    },
    {
      ...
      status: "Live",
      stack:
        "React-Redux-Tailwind-PWA-Chatbot-Webpack-NextJs-Crypto-React hooks-RestAPI-Formik-CSS",
    },
    {
      name: "Profitall",
      stargazerCount: "100",
      ...
      status: "Live",
      stack:
        "React-Redux-Tailwind-Chatbot--Webpack-Cloudinary-React hooks-Rest-charts-Formik-SCSS",
    },
    {
      name: "Mintyn",
      stargazerCount: "100",
    ...
    // },
    {
      ...
      stargazerCount: "100",
      description:
        "A complete commerce platform that will allow merchants to start, grow, and manage a business.",
      url: "https://www.bitmarte.com/",
      status: "Live",
      stack:
        "Nextjs-React-Tailwind-Redux-Mui-Cloudinary-React hooks-Rest-typeScript-AWS",
    },
    {
      name: "Crusifix Games",
      stargazerCount: "100",
      description:
        "The Crucifix Games application is a minimal and responsive web application created to host contests with an intuitive leadership board & point ranking system. Customers can also book and pay for games",
    ...
    // },
    {
      ...
      stargazerCount: "100",
      description:
        "A facility management web application that provides users the ability to request for artisans and related facility management services",
